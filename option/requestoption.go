...
// RequestOption is an option for the requests made by the mpesaflow API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/stainless-sdks/mpesaflow-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return WithBaseURL("https://api.mpesaflow.com/")
}
...
func WithEnvironmentEnvironment1() RequestOption {
	return WithBaseURL("https://sandbox-api.mpesaflow.com/")
}

// WithAppAPIKey returns a RequestOption that sets the client setting "app_api_key".
func WithAppAPIKey(value string) RequestOption {
	return func(r *requestconfig.RequestConfig) error {
		r.AppAPIKey = value
		return r.Apply(WithHeader("X-App-Api-Key", r.AppAPIKey))
	}
}

// WithRootAPIKey returns a RequestOption that sets the client setting "root_api_key".
func WithRootAPIKey(value string) RequestOption {
	return func(r *requestconfig.RequestConfig) error {
		r.RootAPIKey = value
		return r.Apply(WithHeader("X-Root-Api-Key", r.RootAPIKey))
	}
}
