...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Apps.New(context.Background(), mpesaflow.AppNewParams{})
	if userAgent != fmt.Sprintf("Mpesaflow/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.Apps.New(context.Background(), mpesaflow.AppNewParams{})
	if err == nil || res != nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.Apps.New(cancelCtx, mpesaflow.AppNewParams{})
	if err == nil || res != nil {
		t.Error("Expected there to be a cancel error and for the response to be nil")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.Apps.New(deadlineCtx, mpesaflow.AppNewParams{})
		if err == nil || res != nil {
